  ...
  render () {
    ...
    return (
      ...
      <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
        <div style={{width: 540, display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
          {!this.state.myKey || !this.state.myWalletAddress ?
          <button style={{width: 100, height: 40, background: "green", border: "none", color: "white",  borderRadius: "2px"}} onClick={this.handleCreateWallet}>Create wallet</button>
